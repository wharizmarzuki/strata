...
export default function FaqPage() {
  return (
    <div className={styles.viewport}>
      <section className={styles.artboard} aria-label="Soalan Lazim">
        ...
        <button
          type="button"
          className={`${styles.faqOption} ${styles.optionOne}`}
          aria-label="Soalan Lazim pilihan 1"
        />
        <button
          type="button"
          className={`${styles.faqOption} ${styles.optionTwo}`}
          aria-label="Soalan Lazim pilihan 2"
        />
        <button
          type="button"
          className={`${styles.faqOption} ${styles.optionThree}`}
          aria-label="Soalan Lazim pilihan 3"
        />
